...
export const NAV_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/leader",
        icon: Crown,
        anyPermissions: ["analytics.ground_intelligence", "hierarchy.manage"],
        description: "Ground intelligence and leadership tools",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/elections",
        icon: Vote,
        anyPermissions: ["elections.manage", "hierarchy.manage"],
