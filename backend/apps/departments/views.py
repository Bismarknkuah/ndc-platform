...
class TaskAssignmentListCreateView(APIView):
    ...
    GET  /api/v1/departments/tasks/?assigned_to_id=&department_id=&status=
         ...
         authority to view another member's diary.
...
class DepartmentTeamDashboardView(APIView):
    ...
    Visible to anyone with authority over that department+unit, or to a
    member of that specific team looking at their own team's dashboard.
    """
